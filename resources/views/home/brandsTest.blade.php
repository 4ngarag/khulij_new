    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-4">
                <a href="/brands/{{ $brand->id }}" class="gallery-popup" title="More info">
                    <div class="project-item">
                        <div class="overlay-container">
                            <img src="{{ Storage::url($brand->logo) }}" alt="img" class="gallery-thumb-img" style="height: 110px">
                            <div class="project-item-overlay">
                                <h4>{{ $brand->name }}</h4>
                                <p>
                                    <img src="{{ Storage::url($brand->company->{'logo_'.app()->getLocale()}) }}" alt="user" class="thumb-sm rounded-circle">
                                    <span class="ml-2">{{ Str::upper($brand->company->{'name_'.app()->getLocale()}) }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
